  ...
  return (
    <section className="relative grain bg-warm-grey py-20 md:py-32 overflow-hidden">
      <div ref={ref} className="relative max-w-[1100px] mx-auto px-5 md:px-8">
        <h2
          className={`font-bold tracking-tight text-ink section-reveal ${visible ? 'is-visible' : ''}`}
        ...
        <div className={`mt-12 md:mt-16 space-y-4 md:space-y-5 section-reveal ${visible ? 'is-visible' : ''}`} style={{ transitionDelay: '150ms' }}>
          {FOR_YOU.map((item, i) => (
        ...
        <div className={`space-y-3 md:space-y-4 section-reveal ${visible ? 'is-visible' : ''}`} style={{ transitionDelay: '300ms' }}>
