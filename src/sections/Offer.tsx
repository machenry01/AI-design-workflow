    ...
    <section className="relative grain grain-light bg-ink text-white py-20 md:py-32 overflow-hidden">
      ...
      <div ref={ref} className="relative max-w-[1300px] mx-auto px-5 md:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Book */}
          <div
            className={`flex justify-center reveal-scale ${visible ? 'is-visible' : ''}`}
          ...
          <div>
            <div
              className={`flex items-center gap-3 mb-6 reveal-up ${visible ? 'is-visible' : ''}`}
            ...
            <h2
              className={`font-bold tracking-tight text-white reveal-up ${visible ? 'is-visible' : ''}`}
              style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)', lineHeight: '1.0', letterSpacing: '-0.02em', transitionDelay: '300ms' }}
            >
              {PRODUCT_NAME.toUpperCase()}
            </h2>

            <div
              className={`mt-4 flex items-center gap-3 reveal-up ${visible ? 'is-visible' : ''}`}
            ...
            <div
              className={`mt-8 reveal-up ${visible ? 'is-visible' : ''}`}
            ...
            <div
              className={`mt-4 flex items-center gap-2 text-sm text-white/40 reveal-up ${visible ? 'is-visible' : ''}`}
